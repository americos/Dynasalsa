<!-- #include file="dynamix_header.asp" -->
 ...
 <td style="width:570px;background-color:#000000;" align="left">
  <img src="images/services_home.jpg" alt="Team" width="536" height="324" align="top" />
...
<p style="color:#990000; margin:15px 0px 0px 30px; font-weight:600; font-size:16px; ">
  <a style="text-decoration:none; color:#990000;"> Coming Soon </a> <BR />
</p>
